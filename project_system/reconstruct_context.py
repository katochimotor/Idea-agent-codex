...
def main() -> None:
    ...
    print("- SQLite stores jobs, documents, problems, clusters, opportunities, ideas, reports, vectors, and pipeline lineage")
    print("- BackgroundJobWorker polls queued jobs and executes them through PipelineOrchestrationService")
    print("- Discovery flow: collect -> extract -> cluster -> opportunity analysis -> generate -> score -> save")
    ...
    print("- Dashboard also shows Startup Opportunities and latest pipeline results")
